 ...
 */
@WebServlet(description = "dodavanje Profesora", urlPatterns = { "/PrikaziProfesoreController" })
public class PrikaziProfesoreController extends HttpServlet {
	...
	//preko request dispatvhera odredjujemo putanju gde cemo da prosledimo ovu listu
	RequestDispatcher dispatcher = request.getRequestDispatcher("view/prikaziProfesore.jsp");
	//rprwardujemo request
