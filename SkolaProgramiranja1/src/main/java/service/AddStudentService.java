...
public class AddStudentService {
	...
	public Student popuniStudent(String firstName, String lastName, String email, String mobilePhone, String country,
			String city, String street, User user, String indexNo) {
	...
	public Profesor popuniProfesor(String firstName, String lastName, String email, String mobilePhone, String country,
		...
		return common.popuniProfesor(firstName, lastName, email, mobilePhone,
				country, city, street, user, identificationNo);
	}
	...
	public Administrator popuniAdministrator(String firstName, String lastName, String email, String mobilePhone,
		...
		return common.popuniAdministrator(firstName,lastName,email, mobilePhone,
				country,city, street,user,identificationNumber);
	}

	public boolean ubaciAdminstratora(User user, Administrator admin) {
		return dao.ubaciAdminstratora(user,admin);
	}
